...
SKCLUSTER <- ggplot(transform(skmelted,
                    Skater_CLUSTER=factor(Skater_CLUSTER, 
                                         levels=c(9,8,7,6,5,4,3,2,1))), 
                    aes(x = value, y = variable)) + 
     geom_boxplot()+facet_wrap(~Skater_CLUSTER,nrow = 9)
