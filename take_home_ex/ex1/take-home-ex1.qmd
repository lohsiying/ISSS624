...
```{r}
pvalfunc = pnorm(q = 2*abs(gifunc), lower.tail = FALSE)
...
In general, the 2 maps agree with each other, where
...
Another interesting area is the leftmost of the North West zone where hotspots are identified in the non-functional map but comparatively less (just 1 LGA) is identified as coldspot in the functional water point map.
