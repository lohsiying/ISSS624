---
title: "Hands-on Exercise 4: Global and Local Measures of Spatial Autocorrelation"
editor: visual
---
...
#### 4.4.3.2 Computing Monte Carlo Moran's I
...
#### 4.4.3.3 Computing Monte Carlo Maron's I
...
#### 4.4.4.3 Visualising the Monte Carlo Geary's C
...
Based on the local Moran I, counties can be classified as (1) "hot spots", (2) "cold spots", and (3) potential "spatial outliers" as shown in the diagram below.

![](https://www.mdpi.com/sustainability/sustainability-13-02362/article_deploy/html/images/sustainability-13-02362-g002.png) (image reference \[4\])
...
#### 4.6.1.1 Computing local Moran's I
...
#### 4.6.1.2 Mapping local Moran's I
...
-   high-high quadrant: counties Miluo, Wangcheng, Changsha, Liuyang, Zhuzhuo, and Liling whereby these counties have high GDPPC values and are surrounded by counties with high GDPPC.

-   low-low quandrant: counties Taojiang and Pingjiang are "cold spots" whereby these counties have low GDPPC values and are surrounded by counties with low GDPPC.

-   low-high quadrant: counties Longhui and Wugang are "spatial outliers" whereby these counties have low GDPPC values but are surrounded by counties with high GDPPC.

-   high-low quadrant: county Xiangtan is a "spatial outlier" where it has a high GDPPC but is surrounded by counties with low GDPPC.
...
### 4.8.2 Deriving distance-based matrix
...
\[4\] Koutsos TM, Menexes GC, Mamolos AP. The Use of Crop Yield Autocorrelation Data as a Sustainable Approach to Adjust Agronomic Inputs. *Sustainability*. 2021; 13(4):2362. https://doi.org/10.3390/su13042362
